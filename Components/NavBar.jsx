                    ...
                    <div class="p-5 bg-white border rounded shadow-sm">
                      ...
                      >
                        <svg class="w-5 text-gray-600" viewBox="0 0 24 24">
                          <path
                            fill="currentColor"
                            d="M19.7,4.3c-0.4-0.4-1-0.4-1.4,0L12,10.6L5.7,4.3c-0.4-0. 4-1-0.4-1.4,0s-0.4,1,0,1.416.3,6.31-6.3,6.3 c-0.4,0.4-0.4,1, 0,1.404.5,19.9,4.7,20,5,20s0.5-0.1,0.7-0.316.3-6.316.3,6. 3c0.2,0.2,0.5,0.3,0.7,0.350.5-0.1,0.7-0.3 c0.4-0.4,0.4-1, 0-1.4L13.4,1216.3-6.3020.1,5.3,20.1,4.7,19.7,4.3z"
                          />
                        </svg>
                      </button>
                    </div>
